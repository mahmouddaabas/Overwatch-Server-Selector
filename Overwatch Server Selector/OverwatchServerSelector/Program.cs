    ...
    internal class Program
{
        ...
        private string euIpRanges = "35.198.64.0-35.198.191.255,34.107.0.0-34.107.127.255,35.195.0.0-35.195.255.255," +
        ...
        private string naWest1IpRanges = "24.105.0.0-24.105.15.255";
        ...
        private string naWest3IpRanges = "34.19.0.0-34.19.127.255,34.82.0.0-34.83.255.255,34.105.0.0-34.105.127.255," +
            "34.118.192.0-34.118.199.255,34.127.0.0-34.127.127.255,34.145.0.0-34.145.127.255,34.157.112.0-34.157.119.255," +
            "34.157.240.0-34.157.247.255,34.168.0.0-34.169.255.255,35.185.192.0-35.185.255.255,35.197.0.0-35.197.127.255," +
            "35.199.144.0-35.199.159.255,35.199.160.0-35.199.191.255,35.203.128.0-35.203.191.255,35.212.128.0-35.212.255.255," +
            "35.220.48.0-35.220.55.255,35.227.128.0-35.227.191.255,35.230.0.0-35.230.127.255,35.233.128.0-35.233.255.255," +
            "35.242.48.0-35.242.55.255,35.243.32.0-35.243.39.255,35.247.0.0-35.247.127.255";
        private string naCentralIpRanges = "24.105.16.0-24.105.63.255";
        private string naEastIpRanges = "35.236.192.0-35.236.255.255,35.199.0.0-35.199.63.255,34.86.0.0-34.86.255.255," +
            "35.245.0.0-35.245.255.255,35.186.160.0-35.186.191.255,34.145.128.0-34.145.255.255,34.150.128.0-34.150.255.255,34.85.128.0-34.85.255.255";
        ...
        public void playOnMiddleEast()
        {
            ...
            newRule.Protocol = (int)NET_FW_IP_PROTOCOL_.NET_FW_IP_PROTOCOL_ANY;
            newRule.RemoteAddresses = euIpRanges + "," + naCentralIpRanges+ "," + naEastIpRanges + "," + naWest1IpRanges
        ...
        public void startProgram()
        {
            ...
            Console.WriteLine("1. Play on NA servers.");
            Console.WriteLine("2. Play on Middle East servers.");
            try
            {
                ...
                switch (input)
                {
                    case 1:
                        playOnNA();
                        Console.WriteLine("\nNA servers has been selected. You will now play on NA.");
                        break;
                    case 2:
                        playOnMiddleEast();
                        Console.WriteLine("\nMiddle East servers has been selected. You will now play on Middle East.");
                        break;
        ...
        static void Main(string[] args)
        {
            ...
            //delete rules when starting the program incase it didnt get deleted.
            pm.deleteRules();
            pm.startProgram();

            Console.WriteLine("Minimize the program and keep it running.");
            Console.WriteLine("Close the program by pressing Enter to stop blocking.");
            Console.ReadLine(); //to stop console from auto closing
            pm.deleteRules(); //delete rule when application is closed
        }
}
}
